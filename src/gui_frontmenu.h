...
enum GUI_Menus {
  ...
  GMnu_FEACHIEVEMENTS     = 27,
  GMnu_DUNGEON_SPECIAL    = 28,
  GMnu_RESURRECT_CREATURE = 29,
  GMnu_TRANSFER_CREATURE  = 30,
  GMnu_ARMAGEDDON         = 31,
  GMnu_CREATURE_QUERY1    = 32,
  GMnu_CREATURE_QUERY3    = 33,
  GMnu_CREATURE_QUERY4    = 34,
  GMnu_BATTLE             = 35,
  GMnu_CREATURE_QUERY2    = 36,
  GMnu_FEDEFINE_KEYS      = 37,
  GMnu_AUTOPILOT          = 38,
  GMnu_SPELL_LOST         = 39,
  GMnu_FEOPTION           = 40,
  GMnu_FELEVEL_SELECT     = 41,
  GMnu_FECAMPAIGN_SELECT  = 42,
  GMnu_FEERROR_BOX        = 43,
  GMnu_FEADD_SESSION      = 44,
  GMnu_MAPPACK_SELECT     = 45,
  GMnu_MSG_BOX            = 46,
  GMnu_SPELL2             = 47,
  GMnu_ROOM2              = 48,
  GMnu_TRAP2              = 49,
