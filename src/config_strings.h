...
enum GUIStrings {
    ...
    GUIStr_EventCasinoJackpot = STRINGS_MAX+949,
    GUIStr_EventCasinoJackpotDesc,
    GUIStr_CreatureArmourDesc = STRINGS_MAX+951,
    ...
    GUIStr_CreatureScoreDesc = STRINGS_MAX+962,
    GUIStr_CreatureHealthDesc = STRINGS_MAX+967,
